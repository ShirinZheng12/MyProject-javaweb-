	 ...
	 <div class="naver">
	 	<table class="t1">
	 				<tr style=" height: 40px;">
	 					...
	 					<td width="200px"><center><a href="beforeExam.jsp?PaperBefore" target="if"><p class="t11">已结束的课程</p></a></center></td>
	 					<td width="200px"><center><a href="nowExam.jsp?PaperNow" target="if"><p class="t11">正在进行的课程</p></a></center></td>
	 					<td width="200px"><center><a href="afterExam.jsp?PaperAfter" target="if"><p class="t11">即将进行的课程</p></a></center></td>
	 				</tr>
	 			</table>
	 </div>
	 <div class="content">
