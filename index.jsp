...
<body>
	...
	<div id="nave">
		<table id="tab1">
			<tr>
				<td id="td1"></td>
				<td id="td2"><a href="login.jsp">登录</a></td>
				<td width="5px" style="text-align: center;">|</td>
				<td id="td3"><a href="register.jsp">注册</a></td>
			</tr>
		</table>
	</div>
				...
				<div class="cl">
					<ul class="slideshow" id="slidesImgs">
						<li><a href="#" target="_blank"> <img
								src="images/lb01.PNG" width="1040" height="390" alt="" /></a></li>
						<li><a href="#" target="_blank"> <img
								src="images/lb02.PNG" width="1040" height="390" alt="" /></a></li>
						<li><a href="#" target="_blank"> <img
								src="images/lb03.PNG" width="1040" height="390" alt="" /></a></li>
						<li><a href="#" target="_blank"> <img
								src="images/lb04.PNG" width="1040" height="390" alt="" /></a></li>
					</ul>
				</div>
	...
	<div id="main">
		<div id="index_newslist" class="pc_overflow mt10 w980">
			<div id="company_info_gsgg" class="fl pc_overflow">
				<dl>
					<dt class="pc_overflow">
						<b>最新公告</b><span>more+</span>
					</dt>
					<dd>
						<ul>
							<li><a href="#" title="">这里是题库管理系统</a></li>
							<li><a href="#" title="">这里是题库管理系统</a></li>
							<li><a href="#" title="">这里是题库管理系统</a></li>
							<li><a href="#" title="">这里是题库管理系统</a></li>
							<li><a href="#" title="">这里是题库管理系统</a></li>
